...
//    public List<UserResponseDto> getByCity(@PathVariable String city) {
//        return userService.getByCity(city);
//    }
//    
//    @GetMapping("/getEntity/{id}")
//    public User getUserEntityById(@PathVariable Integer id) {
...
public class UserController {
    ...
    // IMPORTANT → used by other services (DO NOT CHANGE)
    @GetMapping("/getEntity/{id}")
    public User getUserEntityById(@PathVariable Integer id) {
        return userService.getUserEntityById(id);
    }

    // ADD LOGIN (new but safe)
    @PostMapping("/login")
