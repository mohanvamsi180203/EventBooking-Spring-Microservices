...
//    }
    ...
    public NotificationResponseDto sendNotification(Notification notification) {
        ...
        if(notification.getAttachmentPath() != null &&
        		   !notification.getAttachmentPath().isEmpty()) {
